...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_with_macro(
    ...
    KC_MPLY, KC_MSTP, KC_GRV,         KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, KC_HOME,
    ...
    KC_F17,  KC_F18,  KC_LCTL,        KC_LALT, KC_LGUI, LT(1, KC_ESC),   XXXXXXX, LT(1, KC_SPC),   KC_SPC,  LT(1, KC_ESC),   KC_MEH,  KC_HYPR, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_80_with_macro(
    ...
    RGB_SAI, RGB_SAD, RGB_TOG, RGB_MOD, _______, _______, _______, _______, SGUI(KC_LBRC), SGUI(KC_RBRC), _______, _______, _______, _______, _______, QK_BOOT,   _______,
    ...
    _______, _______, _______,          _______, _______, _______, _______, LGUI(KC_BSPC), LALT(KC_BSPC), LALT(KC_DEL), LGUI(KC_DEL), _______, _______, _______, _______, _______,
